                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            touch ./bash/$domain_folder/$model_folder/prenewdd.sh
                            tee ./bash/$domain_folder/$model_folder/prenewdd.sh << EOF
#! /bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=pre4dd
#SBATCH --output=./job-outs/$domain_folder/$model_folder/prenewdd.out
#SBATCH --error=./job-outs/$domain_folder/$model_folder/prenewdd.err
...
EOF
                            sbatch ./bash/$domain_folder/$model_folder/prenewdd.sh
                        done
                    done
                done
            done
