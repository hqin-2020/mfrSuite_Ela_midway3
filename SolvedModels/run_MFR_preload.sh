                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            touch ./bash/$domain_folder/$model_folder/predd.sh
                            tee ./bash/$domain_folder/$model_folder/predd.sh << EOF
#! /bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=predd
#SBATCH --output=./job-outs/$domain_folder/$model_folder/predd.out
#SBATCH --error=./job-outs/$domain_folder/$model_folder/predd.err
...
EOF
                            sbatch ./bash/$domain_folder/$model_folder/predd.sh
                        done
                    done
                done
            done
