                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            touch ./bash/$domain_folder/$model_folder/prerep.sh
                            tee ./bash/$domain_folder/$model_folder/prerep.sh << EOF
#! /bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=prerep
#SBATCH --output=./job-outs/$domain_folder/$model_folder/prerep.out
#SBATCH --error=./job-outs/$domain_folder/$model_folder/prerep.err
...
EOF
                            sbatch ./bash/$domain_folder/$model_folder/prerep.sh
                        done
                    done
                done
            done
