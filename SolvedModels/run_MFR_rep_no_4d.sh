                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            touch ./bash/$domain_folder/$model_folder/prerepnm.sh
                            tee ./bash/$domain_folder/$model_folder/prerepnm.sh << EOF
#! /bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=prerepnm
#SBATCH --output=./job-outs/$domain_folder/$model_folder/prerepnm.out
#SBATCH --error=./job-outs/$domain_folder/$model_folder/prerepnm.err
...
EOF
                            sbatch ./bash/$domain_folder/$model_folder/prerepnm.sh
                        done
                    done
                done
            done
