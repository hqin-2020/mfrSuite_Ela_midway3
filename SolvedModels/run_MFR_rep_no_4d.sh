                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            touch ./bash/$domain_folder/$model_folder/prerepn.sh
                            tee ./bash/$domain_folder/$model_folder/prerepn.sh << EOF
#! /bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=prerepn
#SBATCH --output=./job-outs/$domain_folder/$model_folder/prerepn.out
#SBATCH --error=./job-outs/$domain_folder/$model_folder/prerepn.err
...
EOF
                            sbatch ./bash/$domain_folder/$model_folder/prerepn.sh
                        done
                    done
                done
            done
